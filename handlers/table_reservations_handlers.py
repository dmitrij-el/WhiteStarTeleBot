...
# from data.texts import text_user_profile, text_reservation
...
#         await msg.answer(text=text_reservation.add_table_reservations_phone + text_user_profile.basic_data_update['phone'])
...
#
#
# @router.message(StateTableReservations.admin_add_table_reservations_booking_start_time_date)
